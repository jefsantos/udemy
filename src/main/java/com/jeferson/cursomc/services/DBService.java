...
import com.jeferson.cursomc.domain.Cidade;
import com.jeferson.cursomc.domain.Cliente;
import com.jeferson.cursomc.domain.Endereco;
import com.jeferson.cursomc.domain.Estado;
...
import com.jeferson.cursomc.domain.PagamentoComCartao;
...
import com.jeferson.cursomc.repositories.CidadeRepository;
import com.jeferson.cursomc.repositories.ClienteRepository;
import com.jeferson.cursomc.repositories.EnderecoRepository;
import com.jeferson.cursomc.repositories.EstadoRepository;
...
//		Categoria cat8 = new Categoria(null, "BAHAMAS");
		...
		Cliente cli1 = new Cliente(null, "MAria Silva", "jeh.uninove@gmail.com", "35931095810", TipoCliente.PESSOAFISICA);
		cli1.getTelefones().addAll(Arrays.asList("1144430207", "11982180517"));

		Endereco e1 = new Endereco(null, "Rua Flores", "300", "Apto 303", "Jardim", "38220834", cli1, c1);
		Endereco e2 = new Endereco(null, "Evenida matos", "105", "Sala 800", "Centro", "38777012", cli1, c1);
